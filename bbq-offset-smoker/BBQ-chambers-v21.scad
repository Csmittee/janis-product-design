...
OLD_SPLIT_Z    = GRATE_Z;                                // 950mm -- was apex A, the ONLY split point through v20
NEW_SPLIT_Z    = OLD_SPLIT_Z + PARTING_SHIFT;            // 1000mm -- real, live-computed. Coincides with GRATE_Z_FIXED(1000, declared separately below) -- confirmed algebraic coincidence, not a reference, both values stated independently

...
// Version: v3
// Date: 2026-07-14
// Changes from v2: 3 corrections per prompts/bbq-chambers-v3-closure-
// exhaust-resize-lid-mirror-cc-prompt.md (Janis's own review of the
// merged v2 build, real hardware photos + labeled diagrams):
//

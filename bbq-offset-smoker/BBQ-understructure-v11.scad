...
// Version: v11
// Date: 2026-07-21
// Source: BBQ-understructure-v10.scad
// Changes: PURE POINTER BUMP ONLY -- zero understructure geometry changed
// this round. `include` bumped to BBQ-chambers-v20.scad (that round's own
// real fix: outer_shell()'s own flange rebuilt HOLLOW, wall_t thick --
// was a solid 50mm block since v14, a real standing inconsistency with
// this project's own thin-sheet-metal fabrication convention, creating
// two redundant wall-like surfaces where Janis expected exactly one real
// end cap. See BBQ-chambers-v20.scad's own header for full detail).
//
// v10's own original header follows, UNCHANGED, kept as real history:
//
// Changes: PURE POINTER BUMP ONLY -- zero understructure geometry changed

...
// Version: v17
// Date: 2026-07-24
// Source: BBQ-understructure-v16.scad
// Changes: prompts/bbq-lid-hinge-v7-sync-pivot-margin-cc-prompt.md,
// Section 3. PURE POINTER-ONLY BUMP -- zero understructure geometry
// changed this round. `include` bumped BBQ-chambers-v23.scad ->
// BBQ-chambers-v24.scad (that round's TASK 1: `lid_open_deg` moved into
// a `/* [Hidden] */` Customizer group, zero other content changed -- see
// BBQ-chambers-v24.scad's own header). Same real necessity as the
// v15->v16 chain-break fix: v16's own `include` pointed at chambers-v23
// directly, so leaving BBQ-offset-smoker-base-v7.scad pointed at v16
// unchanged would have kept v23 (Customizer-fragile `lid_open_deg`) in
// the real render chain even after v24 was created -- v24 would have
// been committed but silently orphaned, the same failure class this
// project has now hit three times (bbq-base-chain-recalibration,
// 2026-07-22; the v15->v16 fix, 2026-07-24). v16 itself is NOT edited
// (kept byte-identical, on record). R-009 real consumed-datum check
// (grep): every real chambers identifier this file references has the
// IDENTICAL declaration in v24 as in v23 -- zero-consequence pointer
// bump, no fender/track-width/wheel position moves. Table content below
// UNCHANGED from v16.
//

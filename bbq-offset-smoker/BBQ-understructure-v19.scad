...
// Version: v19
// Date: 2026-07-25
// Source: BBQ-understructure-v18.scad
// Changes: Janis direct-cc, real shared hinge-pivot round. PURE POINTER-
// ONLY BUMP -- zero understructure geometry changed this round. `include`
// bumped BBQ-chambers-v25.scad -> BBQ-chambers-v26.scad (that round's own
// real change: new `HINGE_PIVOT_Y`/`HINGE_PIVOT_Z` shared rotation center,
// used by both `lid()` here and the rib assembly in
// BBQ-offset-smoker-base-v9.scad -- see BBQ-chambers-v26.scad's own
// header). Same real necessity as the prior chain-break fixes: leaving
// this file's own `include` pointed at v25 would silently orphan v26 from
// the real render chain. v18 itself is NOT edited (kept byte-identical,
// on record). R-009 real consumed-datum check (grep): every real
// chambers identifier this file references has the IDENTICAL declaration
// in v26 as in v25 -- zero-consequence pointer bump, no fender/track-
// width/wheel position moves. Table content below UNCHANGED from v18.
//
...
// Version: v18
// Date: 2026-07-25
// Source: BBQ-understructure-v17.scad
// Changes: Janis direct-cc, "unify system" ridge-parting-line redesign
// round. PURE POINTER-ONLY BUMP -- zero understructure geometry changed
// this round. `include` bumped BBQ-chambers-v24.scad -> BBQ-chambers-v25.scad
// (that round's own real change: new RIDGE_SPLIT_Y ridge fixed/lid split
// constant, replacing the hardcoded chamber_W/2 reference in
// fixed_side_wedge()/lid_side_wedge()/lid_closed_panels()/lid() -- see
// BBQ-chambers-v25.scad's own header). Same real necessity as the prior
// two chain-break fixes (v15->v16, v16->v17): leaving this file's own
// `include` pointed at v24 would silently orphan v25 from the real render
// chain. v17 itself is NOT edited (kept byte-identical, on record). R-009
// real consumed-datum check (grep): every real chambers identifier this
// file references has the IDENTICAL declaration in v25 as in v24 (only
// the ridge-split's own internal reference point changed, not any
// identifier this file itself reads) -- zero-consequence pointer bump, no
// fender/track-width/wheel position moves. Table content below UNCHANGED
// from v17.
//
// v17's own original header follows, UNCHANGED, kept as real history:
//
// BBQ Offset Smoker — Understructure
// Version: v16
// Date: 2026-07-24

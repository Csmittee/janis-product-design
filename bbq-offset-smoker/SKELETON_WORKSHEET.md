...
> Version 1.31 — 2026-07-30
> Changes: bbq-lid-hinge-v12, CB1 lateral link, FINAL/COMPLETE this round
> (consolidates several same-day rework passes — full history:
> cc_chat_log.md's 2026-07-30 entries). PART C's "Lid hinge/handle/CB1"
> row updated: `cb1_link_2d()` now applies to ALL 3 ribs (widened from
> the source prompt's own original middle-rib-only scope). Bracket
> (Ua/Ub/Uc) + neck (50mm wide) + T4U/t6be/t7/t7u connect it into the
> existing t4/t5 rib body as one solid filled region. `t1`-`t6` profile
> itself untouched (locked). Full labeled reference:

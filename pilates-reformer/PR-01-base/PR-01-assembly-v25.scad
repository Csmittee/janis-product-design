// PR-01-assembly-v25.scad
// Janis Product Design — Pilates Reformer with Full Tower
// Version: v25 — multi-file split (PR-01-multifile-split-v25). PURE REORG:
// no geometry/dimension/module-logic change from PR-01-base-v24.scad. Same
// output. This is now the top-level file Janis opens in OpenSCAD for F5/F6
// full-assembly renders.
// Source: PR-01-base-v24.scad (kept in repo, unchanged, historical record —
// not deleted). All module/function bodies moved verbatim into
// modules/pole_top.scad (NOT individually versioned — see that file's
// header and cc_chat_log.md for the exception rationale).
//
...
// second, modules third, assembly last." This also means modules/
// pole_top.scad's ghost-context stanza (which runs immediately on include)
// never references an undeclared global, even if $is_assembly is later
// toggled false in this same file for isolated-render iteration.
//
// Date: 2026-07-01
...
// Suppress modules/pole_top.scad's ghost-context stand-ins for full-assembly
...
// ── Modules (all definitions live in modules/pole_top.scad) ───────────

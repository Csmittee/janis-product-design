// PR-01-assembly-v26.scad
// Janis Product Design — Pilates Reformer with Full Tower
// Version: v26 — flatten module structure (PR-01-flatten-modules-v26). PURE
// STRUCTURE FIX: identical to v25 except the include path. Janis's working
// folder is local-only (files downloaded individually from GitHub, no git
// clone) — v25's modules/ subfolder cannot be relied on to survive that
// download step, so module files now sit FLAT in the same folder as the
// assembly file. No geometry/dimension/module-logic change from v25 (or v24).
// Source: PR-01-assembly-v25.scad. Module bodies live in pole_top.scad
// (moved from modules/pole_top.scad, NOT individually versioned — see that
// file's header and cc_chat_log.md for the exception rationale).
//

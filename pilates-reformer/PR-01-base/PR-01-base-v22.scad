...
// Version: v22 — profile_pts() orientation fix: condition sin(a)>0 → cos(a)>=0,
// point formula [-r*sin(a), r*cos(a)] → [r*cos(a), r*sin(a)].
// Fixes housing camber appearing sideways (dome on Y) instead of on top (dome on Z).
// Date: 2026-07-01

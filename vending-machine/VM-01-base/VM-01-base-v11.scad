...
//
// Changes from v10:
//   Fix 1: spring_zone_panel() — corrected to world Z=300-542, X=skin_t,
//           Y=0, width=product_w-(skin_t*2). Left product zone only.
//   Fix 2: Roof restored — hollow interior height changed from total_h
//           to total_h-skin_t so top skin is preserved at Z=700.
//   Fix 3: screen_y = skin_t - screen_protrude (was 0 - screen_protrude).
...
screen_y = skin_t - screen_protrude;   // FIX 3: -28mm — 30mm forward of front skin
bracket_r = 8;
bezel_t = 3;
qr_w = 40;
qr_h = 30;
...
// FIX 1: Acrylic customer selection panel — left product zone, Z 300-542.
// X=skin_t, Y=0 (front face), width=product_w-(skin_t*2).
// #ADD8E6 opacity 0.15. Left hinge. Shown closed.

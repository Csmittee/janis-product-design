...
//
// Changes from v13:
//   Fix 1: outer_shell() — hollow subtract uses total_h-(skin_t*2) to close bottom face (fixes 2-manifold)
//   Fix 2: outer_shell opacity corrected to 0.75 (solid shell)
//   Fix 3: Remove duplicate exit_door_h declaration (was declared twice)

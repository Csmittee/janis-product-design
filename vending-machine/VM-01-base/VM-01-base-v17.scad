...
//
// Changes from v16:
//   Fix 1: outer_shell() — reverted v16 Fix 2. Restored assembly translate([0,0,leg_h]) outer_shell().
//           Hollow subtract Z reset to skin_t (local origin). total_h-(skin_t*2) height kept (v14 fix).
//   Diagnosis: 2-manifold source identified via code analysis — see cc_chat_log.md.

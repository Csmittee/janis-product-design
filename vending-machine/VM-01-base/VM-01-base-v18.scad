...
//
// Changes from v17:
//   Fix 1: outer_shell() cutouts — converted all 4 front face cutout Z values from world
//           to local coordinates (local_z = world_z - leg_h). Fixes mixed world/local Z
//           violation that caused geometry to cut outside shell boundary = non-manifold.

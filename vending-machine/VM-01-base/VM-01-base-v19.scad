...
//
// Changes from v18:
//   Fix 1: dashboard() support bracket — replaced hull()+rotated cylinders with flat crossbar cube.
//           Rotated cylinders inside hull() = non-manifold risk. Cube is clean solid geometry.
//   Fix 2: sensor_strip() laser beam visual — cube([...,1,1]) changed to cube([...,2,2]).
//           1mm on two axes = degenerate near-zero geometry, triggers non-manifold warning.

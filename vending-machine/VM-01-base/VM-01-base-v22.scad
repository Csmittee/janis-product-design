...
//
// Changes from v21:
//   Change 1: acrylic_display() top panel translate Z: total_h-skin_t → total_h-(skin_t*2)
//   Change 2: acrylic_display() right panel translate X: total_w-skin_t → total_w-(skin_t*2)
//   Change 3: tray_zone_frame() all 4 bars Y translate: e → e*2

...
//
// Changes from v22:
//   Change 1: spring_zone_panel() panel_h: tray_h*tray_count → total_h-(leg_h+exit_door_h)
//             Extends panel from Z 300-542 to Z 300-700 (full left zone above exit door).
//   Change 2: spring_zone_panel() comment updated: Z 300-542 → Z 300-700
...
module tray_zone_frame() {
    ...
    union() {
        ...
        translate([0, e*2, tray_zone_top_z - frame_bar])

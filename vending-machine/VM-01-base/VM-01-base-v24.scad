...
//
// Changes from v23:
//   Fix 1: spring_tray() — rewritten with single solid box + difference() approach.
//          Eliminates union() T-junction (floor slab + walls) confirmed as sole 2-manifold source.
//   Fix 2: tray_zone_frame() — height updated from tray_zone_h (242mm) to panel_zone_h (400mm).
//          Frame now matches spring_zone_panel() which was extended to Z 300-700 in v23.
//   Add: panel_zone_top_z and panel_zone_h declared in PARAMETERS.

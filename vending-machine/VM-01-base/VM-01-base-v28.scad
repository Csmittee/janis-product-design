...
//
// Changes from v27:
//   spring_tray() for-loop: spring coil Y translate changed from tray_d-motor_d-e to spring_l+e.
//   After rotate([90,0,0]), coil front face = spring_l+e, rear face = e. Coil fills tray Y=e to Y=390.01.

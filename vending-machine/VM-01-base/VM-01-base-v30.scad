...
//
// Changes from v29:
//   Added show_shell_back debug toggle (hide to inspect motor/rear wall contact).
//   Added show_shell_back if-block inside outer_shell_debug() difference().
//   show_shell_top already present in v29 — not duplicated.

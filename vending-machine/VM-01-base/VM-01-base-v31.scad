...
//
// Changes from v30:
//   Fix 1: spring_tray() motor cube Y moved from tray_d-motor_d-e to tray_d-motor_d-tray_wall_t-e.
//           Motor rear face now at 446.98mm — fully inside hollow, clears rear wall inner face (447mm).
//           Removes visual protrusion ("2 dots") through back wall. Motor stays in correct position.
//   Fix 2: Rear motor mount cutout height 35 → 36. Motor top = tray_floor_t+e+35 = 40.01mm was
//           0.01mm above cutout top (40mm). Cutout now ends at 41mm — full clearance, no manifold risk.
...
// ─────────────────────────────
show_shell_back  = true;   // hide to inspect motor/rear wall contact

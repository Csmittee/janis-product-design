...
//
// Changes from v32:
//   spring_tray() for-loop: coil translate Y changed from spring_l+e to tray_d-motor_d-2.
//   Coil rear face now at tray_d-motor_d-2 = 388mm. Anchors coil relative to motor,
//   2mm clearance from motor front face. Coil no longer penetrates motor block visually.

...
// Derived from: VM-02-base-v1.scad (this session, source vm02-lower-
// shell-fill-and-retro-governance) — v1 itself derived from
// vending-machine/VM-01-base/VM-01-base-v58.scad. v1 is UNTOUCHED,
// this is a new file, same convention as VM-01's own per-version files.
//
// CHANGES FROM v1 (this session, vm02-lower-shell-fill-and-retro-governance):
//
